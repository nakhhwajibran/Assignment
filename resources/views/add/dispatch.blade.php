            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('dispatch.add') }}">
                            @csrf

                            <div class="form-group row">
                                <label for="delivery_no" class="col-md-4 col-form-label text-md-right">Delivery No</label>
                                <div class="col-md-6">
                                    <input id="delivery_no" type="number" class="form-control @error('delivery_no') is-invalid @enderror" name="delivery_no" value="{{ old('delivery_no') }}" autocomplete="delivery_no" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="shipment_noshipment_no" type="number" class="form-control @error('shipment_no') is-invalid @enderror" name="shipment_no" value="{{ old('shipment_no') }}" autocomplete="shipment_no" autofocus>
                                    @error('shipment_no')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="source_id" id="source_id" class="form-control @error('source_id') is-invalid @enderror">
                                        ...
                                        @foreach($source as $s)
                                        <option value="{{ $s['id'] }}" @if( old('source_id')==$s['id'] ) {{ "selected" }} @endif>{{ $s['city'].' , '. $s['state'] .' , '. $s['country']}}</option>
                                        @endforeach
                                    </select>
                                    @error('source_id')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="destination_id" id="destination_id" class="form-control @error('source_id') is-invalid @enderror">
                                        ...
                                        <option value="{{ $d['id'] }}" @if( old('destination_id')==$d['id'] ) {{ "selected" }} @endif>{{ $d['city'].' , '. $d['state'] .' , '. $d['country']}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="vehicle_id" id="vehicle_id" class="form-control @error('vehicle_id') is-invalid @enderror">
                                        ...
                                        <option value="{{ $v['id'] }}" @if( old('vehicle_id')==$v['id'] ) {{ "selected" }} @endif>{{ $v['vehicle_no'].' - '. $v['vehicle_model'] .' - '. $v['vehicle_name']}}</option>
                                        @endforeach
                                    </select>
                                    @error('vehicle_id')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="transporter_id" id="transporter_id" class="form-control @error('transporter_id') is-invalid @enderror">
                                        ...
                                        <option value="{{ $t['id'] }}" @if( old('transporter_id')==$t['id'] ) {{ "selected" }} @endif>{{ $t['name'] }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="driver_id" id="driver_id" class="form-control @error('driver_id') is-invalid @enderror">
                                        ...
                                        <option value="{{ $dr['id'] }}" @if( old('driver_id')==$dr['id'] ) {{ "selected" }} @endif> {{ $dr['name'].' , '. $dr['phone'] }} </option>
                                        @endforeach
                                    </select>
                                    @error('driver_id')
                                    <span class="invalid-feedback" role="alert">
