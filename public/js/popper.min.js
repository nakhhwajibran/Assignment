...
!(function(e, t) {
    ...
    function O(e) {
        ...
        if (
            null !=
            (o = o ? (0 <= ["top", "bottom"].indexOf(o) ? "x" : "y") : null)
        )
    ...
    function w(e) {
        ...
        if (p) {
            ...
            v === n(o) && (v = s(o)),
                "top" === i &&
                    ((g = "bottom"),
                    (l -= v.clientHeight - r.height),
                    (l *= f ? 1 : -1)),
                "left" === i &&
                    ((h = "right"),
                    (e -= v.clientWidth - r.width),
                    (e *= f ? 1 : -1));
        }
        return (
    ...
    function j(e, r) {
        if ("viewport" === r) {
            ...
            r &&
                ...
                (e = x((e = { width: p, height: a, x: l + c(e), y: u })));
    ...
    (e.createPopper = T),
        ...
        (e.detectOverflow = function(e, n) {
            ...
            (f = e.rects.popper),
                ...
                (f = x(Object.assign(Object.assign({}, f), p))),
                (c = "popper" === i ? f : c);
            var u = {
